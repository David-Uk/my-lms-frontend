        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <Card className="lg:col-span-1 border-none shadow-lg">
            <CardHeader>
              ...
              <CardDescription>
                {activeTab === 'quiz' && 'Generate a custom quiz for your students.'}
                {activeTab === 'flashcards' && 'Create study aids for your courses.'}
                {activeTab === 'transcribe' && 'Transcribe lecture recordings.'}
              </CardDescription>
            </CardHeader>
          ...
          <div className="lg:col-span-2">
            {!result && !isLoading ? (
              <div className="h-full min-h-[400px] bg-gray-50 border-2 border-dashed border-gray-200 rounded-3xl flex flex-col items-center justify-center text-gray-400 p-8 text-center">
                ...
                <p className="max-w-xs mt-2 opacity-50">Select a tool and provide a topic to generate materials.</p>
              </div>
            ) : isLoading ? (
              <div className="h-full min-h-[400px] bg-white rounded-3xl shadow-lg p-12 flex flex-col items-center justify-center text-center space-y-4">
                ...
                <p className="text-gray-500">Generating premium course materials for you.</p>
              </div>
            ) : (
